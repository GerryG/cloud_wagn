...
require "columnize"
  ...
  s.files = ["AUTHORS", "COPYING", "ChangeLog", "Makefile", "NEWS", "README.md", "Rakefile", "lib/columnize.rb", "lib/version.rb", "lib/Makefile", "test/test-columnize.rb", "test/test-hashparm.rb"]
  s.homepage = %q{http://rubyforge.org/projects/rocky-hacks/columnize}
  s.licenses = ["GPL2"]
  s.rdoc_options = ["--main", "README.md", "--title", "Columnize 0.3.3 Documentation"]
  s.require_paths = ["lib"]
